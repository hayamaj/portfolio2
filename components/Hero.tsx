      ...
      <div className="absolute pointer-events-none inset-0 flex items-center justify-center
        ...
        <div className="flex justify-center relative my-20 z-10">
            <div className="max-w-[89vw] md:max-w-2xl lg:max-w-[60vw] flex flex-col items-center justify-center">
                ...
                <p className="lowercase text-center font-medium tracking-widest md:tracking-wider mb-4 text-xs md:text-lg lg:text-xl text-white mt-4">Hi, I&apos;m Haya <span className="text-white font-light">( hey - ya )</span>, a creative developer based in <span className="text-white font-medium">New York</span>.</p>
