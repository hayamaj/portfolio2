        ...
        <div className="flex justify-left ml-4 relative my-20 mb-56 z-10">
            <div className="max-w-[89vw] md:max-w-2xl lg:max-w-[60vw] flex flex-col items-left justify-left">
                ...
                <div className="px-8 py-24">
                        ...
                        <p className="mt-4 text-red-300 text-left lowercase">
                            My Role: <strong className="text-red-400">Product Lead/Manager</strong>
                        </p>
                        <p className="mt-0 text-red-300 text-left lowercase">
                            Tech Stack: <strong className="text-red-400">React Native, Expo, TypeScript, Firebase & Google Auth</strong>
                        </p>
                        <p className="mt-4 text-red-400 text-left max-w-5xl lowercase">
                        Click here to watch a <Link href="/product/dibs/demo" className="underline decoration-1 underline-offset-2 text-red-400 font-bold">demo</Link> of the app.
                    </p>
                    </div>
                ...
                <h2 className="text-xl text-red-400 font-bold text-left mb-1 lowercase">product evolution</h2>
                    ...
                    <p className="mt-4 text-red-300 text-left lowercase">
                            My Role: <strong className="text-red-400">Technical Innovator/Lead Developer</strong>
                        </p>
                        <p className="mt-0 text-red-300 text-left lowercase">
                ...
                <h2 className="text-sm font-bold text-red-400 text-left lowercase">V2 &#8212; </h2>
                    ...
                    <div className="mt-12 text-black text-left max-w-5xl lowercase">
                    <h2 className="mt-4 text-md font-bold text-red-400 text-left lowercase">what changed here?</h2>
                        <ul className="ml-4 mt-4 text-md list-none space-y-2">
                            <li><strong className="text-xl text-red-400 lowercase"> 1 Expanded</strong> dev team.</li>
                            <li><strong className="text-xl text-red-400 lowercase"> 2 Migrated</strong> from web to mobile.</li>
                            <li><strong className="text-xl text-red-400 lowercase"> 3 Performed</strong> an overhaul of app&apos;s UI/UX.</li>
                            <li><strong className="text-xl text-red-400 lowercase"> 4 Explored</strong> more efficient solutions.</li>
                        </ul>
                    </div>
                ...
                <h2 className="text-xl text-red-400 font-bold text-left mb-1 lowercase">my role</h2>
                    <p className="mt-4 text-[#333333] font-medium text-left max-w-5xl lowercase">
